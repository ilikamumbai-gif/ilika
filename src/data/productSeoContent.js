...
export const PRODUCT_SEO_CONTENT = [
  {
    ...
    faqs: [
      {
        question: "What is the Ilika Automatic Voice Face Mask Maker Machine?",
        answer: "It's a smart, voice-guided facial appliance that lets you make fresh, natural DIY face masks at home using fruits, vegetables, and a collagen peptide capsule. It's designed for personalized skincare and home spa treatments, with step-by-step voice guidance through the entire process.",
      },
      {
        question: "How much does the Ilika Voice Face Mask Maker cost?",
        answer: "The Ilika Voice Face Mask Maker Machine is priced at ₹4,499 (MRP ₹7,999, 44% off) on the official Ilika website. It's also available on Amazon (₹5,999) and Flipkart (₹5,998). Paying online gets you an additional flat ₹100 off, bringing the price to ₹4,399.",
      },
      {
        question: "Does the Ilika Mask Maker come with a warranty?",
        answer: "Yes, it comes with a 1 Year Warranty, backed by Ilika's customer support team.",
      },
      {
        question: "Is EMI available for the Ilika Mask Maker Machine?",
        answer: "Yes, No Cost EMI is available — starting at approximately ₹1,500/month for 3 months, payable via UPI and cards at checkout.",
      },
      {
        question: "How is a mask maker machine different from a store-bought sheet mask?",
        answer: "Unlike store-bought sheet masks, which use a fixed formula and require chemical preservatives for shelf life, the Ilika Mask Maker creates a fresh mask each time using your own choice of ingredients. It's also more cost-effective over time — you pay once for the device and only need cheap ingredients per use, versus recurring costs for single-use sheet masks. It does require about 3–5 minutes of prep, compared to a store-bought mask being ready instantly.",
      },
      {
        question: "Why choose Ilika over generic/unbranded mask maker machines?",
        answer: "Ilika offers a warranty and dedicated customer support as an Indian D2C brand, along with verified reviews on both its own website and Amazon.in. Generic or unbranded machines often come with no warranty, unclear seller support, and unpredictable pricing.",
      },
      {
        question: "What ingredients can I use in the Ilika Face Mask Maker?",
        answer: "You can use fresh fruits, vegetables, and a collagen peptide capsule to create a customized facial mask suited to your skin's needs.",
      },
      {
        question: "Is the Ilika Mask Maker eco-friendly?",
        answer: "Yes — since it's a reusable device, it produces minimal packaging waste compared to the single-use sachet waste generated by store-bought sheet masks.",
      },
      {
        question: "Where can I buy the Ilika Voice Face Mask Maker?",
        answer: "It's available on the official Ilika website (ilika.in), as well as Amazon, Flipkart, and Meesho.",
      },
      {
        question: "What is the return/replacement policy?",
        answer: "Ilika offers a Returns Policy and Warranty Claim process — details are available on the Ilika website under Support, or by contacting customersupport.ilika@gmail.com.",
      },
    ],
  },
  {
    ...
    ignoredFaqs: [
      { question: "What is a BLDC hair dryer?", answer: "A BLDC hair dryer uses a brushless DC motor instead of a traditional motor, giving faster airflow, less noise, and a longer motor lifespan. The Ilika hair dryer uses a 110,000 RPM BLDC motor for fast, salon-style drying." },
      { question: "Is the Ilika hair dryer good for frizzy hair?", answer: "Yes, the Ilika hair dryer uses ionic technology, which releases negative ions to neutralize static and reduce frizz, leaving hair smoother and shinier." },
      { question: "Does the Ilika hair dryer cause heat damage?", answer: "No, it's built with smart thermo-control that limits excess heat, reducing the risk of heat damage compared to standard hair dryers used over prolonged periods." },
      { question: "How fast does the Ilika hair dryer dry hair?", answer: "With a 110,000 RPM motor, the Ilika hair dryer dries hair in seconds, significantly faster than a standard hair dryer motor." },
      { question: "Is the Ilika hair dryer noisy?", answer: "No, it uses noise-reducing technology, making it quieter than most conventional hair dryers." },
      { question: "What's the difference between ionic and normal hair dryers?", answer: "An ionic hair dryer like Ilika's releases negative ions to reduce frizz and static, while a normal hair dryer has little to no frizz control and can cause more static and dryness over time." },
      { question: "Is the Ilika hair dryer suitable for all hair types?", answer: "Yes, it's designed for all hair types — straight, wavy, curly, and frizzy — and is suitable for both men and women." },
      { question: "Does the Ilika hair dryer have temperature control?", answer: "Yes, it includes temperature control settings so you can adjust heat levels for your hair type and styling needs." },
      { question: "What colors does the Ilika hair dryer come in?", answer: "It's available in Black, White, and Purple." },
      { question: "Does the Ilika hair dryer come with a warranty?", answer: "Yes, it comes with a 1-year warranty." },
      { question: "How much does the Ilika hair dryer cost?", answer: "The Ilika High-Speed BLDC Hair Dryer is priced at ₹2,699 (discounted from ₹5,999), with EMI options available starting around ₹900/month." },
  ...
  },
  {
    ...
    title: "ilika High-Speed Leafless Hair Dryer - Ionic, Zero Heat Damage | For Men & Women",
