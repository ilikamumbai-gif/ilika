        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-6 sm:pb-8">
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
            ...
            <div className="flex flex-col items-center gap-2 hover:scale-110 transition">
              ...
              <p className="text-sm">customersupport.ilika@gmail.com</p>
            </div>
          ...
          <div className="mt-14 grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="shadow-sm overflow-hidden h-[350px] sm:h-[420px]">
              ...
              <iframe title="Ilika Location" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3761.940465219836!2d72.80658861124637!3d19.458133481750863!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7a97d3bf1059d%3A0xfdf212b78d579f0f!2sHirubai%20Residency!5e0!3m2!1sen!2sin!4v1776163885594!5m2!1sen!2sin" className="w-full h-full border-0" loading="lazy" aria-hidden="true" tabIndex="-1"></iframe>
