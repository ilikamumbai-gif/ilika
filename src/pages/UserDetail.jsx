                                ...
                                <div className="mt-4 pt-4 border-t border-dashed border-gray-200">
                                  ...
                                  <div className="mt-3 rounded-xl border border-rose-100 bg-rose-50/60 p-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                    ...
                                    <button
                                      ...
                                      disabled={!isCancellationAllowed(order.status) || cancelBusyOrderId === order.id}
                                      className="inline-flex items-center justify-center rounded-lg bg-rose-600 hover:bg-rose-700 disabled:bg-gray-300 disabled:text-gray-600 disabled:cursor-not-allowed text-white px-3 py-2 text-xs font-semibold transition-colors"
                                    >
