...
const Blog = () => {
  ...
  const landingCards = useMemo(() => [
    ...
    { id: "landing-leafless-hairdryer", title: "Explore Ilika High-Speed Leafless Hair Dryer", image: productImage((name) => name.includes("leafless hair dryer"), "/Images/HairdrayerCard.webp"), linkPath: "/product/leafless-hair-dryer" },
