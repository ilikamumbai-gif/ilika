  ...
  return <>
    ...
    <div className="min-h-screen bg-white text-[#1C371C]">
      ...
      <main className="mx-auto max-w-7xl bg-white px-3 py-7 sm:px-6 sm:py-10">
        <section className="mb-8 flex flex-col gap-4 rounded-2xl border border-[#ececec] bg-[#faf8f5] p-6 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="text-xl font-semibold">Ilika Articles</h2>
            <p className="mt-2 text-sm text-[#4a5f4a]">Beauty, skincare and haircare guides, all in one place.</p>
          </div>
          <Link to="/articles" className="inline-flex shrink-0 items-center justify-center rounded-full bg-[#801f1f] px-6 py-3 text-sm font-semibold text-white">Browse all articles</Link>
        </section>
        <section>
