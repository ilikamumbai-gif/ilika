      ...
      <div className="primary-bg-color min-h-screen">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py- text-gray-700 leading-relaxed">
          ...
          <section className="mt-8 space-y-3">
            ...
            <p className="mt-2">
              📧 Email: <span className="font-medium">customersupport.ilika@gmail.com</span>
            </p>
          </section>
          ...
          <section className="mt-8 space-y-3">
            ...
            <p>📧 Email: <span className="font-medium">customersupport.ilika@gmail.com</span></p>
          </section>
          ...
          <section className="mt-8 space-y-3">
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm border space-y-2">
              ...
              <p>📧 customersupport.ilika@gmail.com</p>
              <p>📞 9270114738</p>
