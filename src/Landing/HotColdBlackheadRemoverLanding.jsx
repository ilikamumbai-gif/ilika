    ...
    <div className="bg-[#0a0d14] text-[#e8ecf4] [font-family:'DM_Sans',sans-serif]">
      ...
      <style>{`
        ...
        .hot-cold-cta {
          ...
          background: #e63946;
          box-shadow: 0 18px 44px rgba(230,57,70,0.28);
        }
        .hot-cold-cta::before {
          content: "";
          position: absolute;
          ...
          background: linear-gradient(135deg, rgba(255,255,255,0.12) 0%, rgba(255,255,255,0) 52%, rgba(0,0,0,0.1) 100%);
        }
        .hot-cold-cta::after {
          content: "";
          position: absolute;
      ...
      <section className="relative overflow-hidden px-4 pb-8 pt-4 sm:px-[6%] sm:pb-16 sm:pt-12">
        <div className="absolute right-[-96px] top-[-72px] h-[220px] w-[220px] rounded-full bg-[radial-gradient(circle,_rgba(230,57,70,0.18)_0%,_transparent_70%)] sm:right-[-140px] sm:top-[-120px] sm:h-[420px] sm:w-[420px]" />
        <div className="absolute bottom-[-80px] left-[-60px] h-[200px] w-[200px] rounded-full bg-[radial-gradient(circle,_rgba(30,111,217,0.18)_0%,_transparent_70%)] sm:bottom-[-120px] sm:left-[-80px] sm:h-[340px] sm:w-[340px]" />

        <div className="mx-auto grid max-w-[1320px] grid-cols-1 gap-6 lg:grid-cols-[0.94fr_1.06fr] lg:items-center lg:gap-14">
          <div className="order-2 text-center lg:order-1 lg:text-left">
            <p className="mb-4 inline-flex items-center justify-center gap-2 text-[10px] uppercase tracking-[0.22em] text-[#e63946] sm:mb-5 sm:gap-3 sm:text-[11px] lg:justify-start">
              <span className="h-px w-8 bg-[#e63946]" />
              New Launch · Ilika Skintech
            </p>

            <h1 className="[font-family:'Cormorant_Garamond',serif] text-[clamp(34px,12vw,72px)] font-light leading-[0.92] tracking-[-0.03em] text-[#e8ecf4]">
              Hot &amp; Cold
              <br />
            ...
            <p className="mx-auto mt-4 max-w-[520px] text-[14px] leading-6 text-[#8892a8] sm:mt-6 sm:text-base sm:leading-8 lg:mx-0">
            ...
            <div className="mt-6 flex flex-col items-center gap-3 sm:mt-8 sm:flex-row sm:flex-wrap sm:items-center lg:items-start">
              <button
                type="button"
              ...
              <a
                href={productPath}
                className="inline-flex min-h-[46px] items-center gap-2 rounded-full border border-white/10 px-5 text-[13px] tracking-[0.05em] text-[#e8ecf4] transition hover:gap-3 hover:border-[#e63946]/40 hover:text-[#e63946] lg:border-transparent lg:px-0"
              >
                Know More
          ...
          <div className="relative order-1 mx-auto flex w-full max-w-[620px] items-center justify-center lg:order-2">
            <div className="relative w-full overflow-hidden rounded-[24px] border border-[#1e6fd9]/20 bg-[linear-gradient(155deg,_#05091a_0%,_#0a0f20_100%)] px-3 py-6 shadow-[0_18px_48px_rgba(0,0,0,0.28)] sm:rounded-[28px] sm:px-8 sm:py-10">
              ...
              <div className="relative flex items-center justify-center">
                <OptimizedImage
                  ...
                  className="mx-auto max-h-[260px] w-auto object-contain drop-shadow-[0_28px_50px_rgba(0,0,0,0.35)] sm:max-h-[480px]"
                />
              </div>

              <div className="mt-5 grid grid-cols-1 gap-3 sm:absolute sm:left-4 sm:top-8 sm:mt-0 sm:max-w-[180px]">
      ...
      <section className="cv-auto bg-[#05070f] px-4 py-4 sm:px-[6%] sm:py-5">
        <div className="mx-auto grid max-w-[1320px] grid-cols-2 gap-2.5 sm:flex sm:flex-wrap sm:items-center sm:justify-center sm:gap-x-8 sm:gap-y-3">
          {trustItems.map((item) => {
            const Icon = item.icon;
            return (
              <div key={item.label} className="inline-flex min-h-[44px] items-center justify-center gap-2 rounded-xl border border-white/6 bg-white/[0.02] px-3 text-center text-[10px] uppercase tracking-[0.08em] text-[#e8ecf4]/80 sm:min-h-0 sm:rounded-none sm:border-0 sm:bg-transparent sm:px-0 sm:text-xs">
      ...
      <section id="how-it-works" className="cv-auto bg-[#0a0d14] px-4 py-10 sm:px-[6%] sm:py-24">
        <div className="mx-auto max-w-[1320px]">
          ...
          <div className="mobile-scrollbar-hide mt-8 -mx-4 flex snap-x snap-mandatory gap-3 overflow-x-auto px-4 sm:mx-0 sm:grid sm:grid-cols-2 sm:gap-[1px] sm:overflow-hidden sm:px-0 sm:rounded-md sm:border sm:border-[#1e6fd9]/20 sm:bg-[#1e6fd9]/15 xl:grid-cols-4">
            {steps.map((step) => {
              const Icon = step.icon;
              return (
                <div key={step.number} className={`relative ${step.panel} min-w-[82%] snap-center rounded-2xl border border-[#1e6fd9]/20 px-5 py-6 transition hover:bg-[#0a0d14] sm:min-w-0 sm:rounded-none sm:border-0 sm:px-6 sm:py-8`}>
      ...
      <section id="modes" className="cv-auto bg-[#060912] px-4 py-10 sm:px-[6%] sm:py-24">
        <div className="mx-auto max-w-[1320px]">
          <p className="inline-flex items-center gap-2 text-[10px] uppercase tracking-[0.22em] text-[#e63946] sm:text-[11px]">
            <span className="h-px w-6 bg-[#e63946]" />
            Complete Skincare
          ...
          <div className="mobile-scrollbar-hide mt-8 -mx-4 flex snap-x snap-mandatory gap-3 overflow-x-auto px-4 sm:mx-0 sm:grid sm:grid-cols-2 sm:gap-4 sm:overflow-visible sm:px-0 lg:grid-cols-3 xl:grid-cols-5">
            {modes.map((mode) => (
              <div
                key={mode.title}
                className="min-w-[82%] snap-center rounded-2xl border border-[#1e6fd9]/18 bg-[#0d1120] px-5 py-6 transition hover:border-[#1e6fd9]/50 hover:bg-white/[0.03] sm:min-w-0 sm:rounded-md"
              >
      ...
      <section id="specs" className="cv-auto bg-[#0d1120] px-4 py-10 sm:px-[6%] sm:py-24">
          ...
          <div>
            ...
            <div className="mt-8 overflow-hidden rounded-md border border-[#1e6fd9]/15">
              {specs.map(([label, value]) => (
                <div key={label} className="flex flex-col gap-1.5 border-b border-[#1e6fd9]/12 bg-[#0a0d14] px-4 py-4 last:border-b-0 sm:flex-row sm:items-start sm:justify-between sm:gap-4 sm:px-5">
                  <span className="text-[11px] uppercase tracking-[0.12em] text-[#8892a8]">{label}</span>
                  <span className="text-sm font-medium text-[#e8ecf4] sm:max-w-[58%] sm:text-right">{value}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="cv-auto bg-[#0a0d14] px-4 py-10 sm:px-[6%] sm:py-24">
        <div className="mx-auto grid max-w-[1320px] grid-cols-1 gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:gap-14">
          ...
          <div className="space-y-4 sm:space-y-5">
            {benefits.map((benefit) => {
              ...
              return (
                <div key={benefit.title} className="flex gap-4 rounded-2xl border border-[#1e6fd9]/14 bg-[#0d1120] p-4 sm:rounded-none sm:border-0 sm:bg-transparent sm:p-0">
                  <div className="mt-1 grid h-11 w-11 shrink-0 place-content-center rounded-xl border border-[#1e6fd9]/25 text-[#e63946] sm:rounded-sm">
                    <Icon className="h-5 w-5" />
                  </div>
                  <div>
          ...
          <div className="lg:col-span-2 mt-8 flex justify-center lg:mt-10">
            <button
              type="button"
              onClick={handleBuyNow}
              disabled={!targetProduct || !hasLivePrice}
      ...
      <section id="reviews" className="cv-auto bg-[#0f1320] px-4 py-10 sm:px-[6%] sm:py-24">
        <div className="mx-auto max-w-[1320px]">
          <p className="inline-flex items-center gap-2 text-[10px] uppercase tracking-[0.22em] text-[#e63946] sm:text-[11px]">
            <span className="h-px w-6 bg-[#e63946]" />
            Real Reviews
      ...
      <div
        className={`fixed inset-x-0 bottom-0 z-40 border-t border-[#1e6fd9]/20 bg-[#060912]/95 px-3 pb-[calc(12px+env(safe-area-inset-bottom))] pt-3 backdrop-blur-md transition duration-200 lg:hidden ${
