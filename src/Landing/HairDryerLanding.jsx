    ...
    <div className="bg-[radial-gradient(circle_at_top,_#171717_0%,_#090909_45%,_#050505_100%)] text-[#f8f7ff] [font-family:'DM_Sans',sans-serif]">
      ...
      <section className="grid grid-cols-1 lg:min-h-[640px] lg:grid-cols-2">
        <div className="px-6 py-10 sm:px-10 lg:flex lg:flex-col lg:justify-center lg:px-14 lg:py-8">
          <p className="mb-8 inline-flex items-center gap-3 text-[11px] uppercase tracking-[0.3em] text-[#c4b5fd]">
          ...
          <p className="mb-6 max-w-md text-[15px] leading-7 text-[#f5f3ff]">
          ...
          <div className="flex flex-wrap items-center gap-6">
            <button
              ...
              className="group relative min-h-[82px] w-full max-w-[620px] cursor-pointer overflow-hidden rounded-[6px] border border-[#9569d0] bg-[#9569d0] px-10 py-5 text-lg font-bold uppercase tracking-[0.14em] text-white transition duration-300 hover:-translate-y-0.5"
            >
          ...
          <div className="mt-3 flex flex-wrap items-center gap-4">
            ...
            <a href={productPath} className="text-xs uppercase tracking-[0.16em] text-[#f9f7ff]/80 transition hover:text-[#f9f7ff]">
              See details {"->"}
            </a>
          </div>
          {couponApplied ? (
      ...
      <section className="border-b border-[#9569d0]/45 px-6 py-12 sm:px-10 lg:px-14">
        <div className="mb-7 flex items-center gap-4">
          <span className="h-px w-10 bg-[#9569d0]" />
          <p className="[font-family:'Bebas_Neue',sans-serif] text-4xl font-bold leading-none tracking-[0.08em] text-[#f5f3ff]">Performance Snapshot</p>
        </div>
        <div className="grid grid-cols-1 border border-[#9569d0]/45 sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((s) => (
            <div key={s.label} className="border-r border-[#9569d0]/45 bg-[#22163a] p-8 last:border-r-0 sm:odd:border-r sm:even:border-r-0 lg:even:border-r lg:[&:nth-child(4)]:border-r-0">
      ...
      <section id="features" className="border-b border-[#9569d0]/45 px-6 py-14 sm:px-10 lg:px-14">
        <div className="mb-8 flex items-center gap-4">
          <span className="h-px w-10 bg-[#9569d0]" />
          <p className="[font-family:'Bebas_Neue',sans-serif] text-4xl font-bold leading-none tracking-[0.08em] text-[#f5f3ff]">Features & Benefits</p>
        </div>
        ...
        <div>
          ...
          <button
            type="button"
            onClick={handleBuyNow}
            className="group relative mt-8 min-h-[82px] w-full max-w-[620px] cursor-pointer overflow-hidden rounded-[6px] border border-[#9569d0] bg-[#9569d0] px-10 py-5 text-lg font-bold uppercase tracking-[0.14em] text-white transition duration-300 hover:-translate-y-0.5"
          >
      ...
      <section className="border-b border-[#9569d0]/45 px-6 py-16 sm:px-10 lg:px-14">
        <div className="mb-8 flex items-center gap-4">
          <span className="h-px w-10 bg-[#9569d0]" />
          <p className="[font-family:'Bebas_Neue',sans-serif] text-4xl font-bold leading-none tracking-[0.08em] text-[#f5f3ff]">
            Core Technology
          </p>
        </div>
      ...
      <section className="border-b border-[#9569d0]/45 px-6 py-16 sm:px-10 lg:px-14">
        ...
        <div className="grid grid-cols-1 gap-[1px] bg-[#9569d0]/35 lg:grid-cols-3">
          {reviews.map((r) => (
            <div key={r.name} className="bg-[#22163a] p-8 transition hover:bg-[#2d1f4d]">
              <div className="mb-4 flex items-center gap-1 text-[#c4b5fd]">
                {[1, 2, 3, 4, 5].map((n) => (
                  <FaStar key={`${r.name}-${n}`} className="h-3.5 w-3.5" />
                ))}
              </div>
              <div className="mb-5 flex h-[24rem] items-center justify-center overflow-hidden rounded-md border border-[#9569d0]/45 bg-[#0d0b12]">
      ...
      <section className="grid grid-cols-1 gap-10 px-6 py-16 sm:px-10 lg:grid-cols-2 lg:px-14">
        ...
        <div className="border border-[#9569d0] bg-[#9569d0]/10 p-8">
          <p className="mb-1 [font-family:'Bebas_Neue',sans-serif] text-6xl text-[#c4b5fd]">
          ...
          <button type="button" onClick={handleBuyNow} className="block w-full cursor-pointer rounded bg-[#9569d0] px-6 py-4 text-center text-xs font-semibold uppercase tracking-[0.2em] text-black transition hover:bg-[#c4b5fd]">
