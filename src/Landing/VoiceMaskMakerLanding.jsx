          ...
          <div className="flex w-full flex-col">
            ...
            <div className="mb-3 flex w-full max-w-[760px] flex-col gap-3 sm:flex-row sm:flex-wrap">
              <button
                ...
                className="inline-flex h-auto min-h-[48px] w-full items-center justify-center gap-2 rounded-[10px] border border-dashed border-[rgba(198,160,109,0.65)] bg-[rgba(198,160,109,0.14)] px-3 py-2 text-[11px] font-semibold tracking-[0.04em] text-[#B68544] transition hover:bg-[rgba(198,160,109,0.22)] sm:h-[48px] sm:min-w-[320px] sm:flex-1 sm:px-4 sm:py-0 sm:text-[12px] sm:tracking-[0.05em]"
              >
              ...
              <a
                href={productPath}
                className="inline-flex h-[42px] w-full items-center justify-center px-1 text-[14px] font-semibold text-[#8F5A4E] underline-offset-2 hover:text-[#75483F] hover:underline sm:h-[48px] sm:min-w-[170px] sm:w-auto sm:text-[15px]"
              >
                Know More ↓
              </a>
            </div>
