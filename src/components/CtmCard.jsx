...
const steps = [
  {
    ...
    num: "01",
    tag: "Step One",
    title: "ilika's Gentle Cleanser",
    subtitle: "The Foundation of Clear Skin",
    body: "A mild yet powerful cleanser that deep-cleans your pores, clearing out dirt, excess oil, and impurities without stripping your skin's natural moisture barrier — the first and most essential step in any effective routine.",
    benefits: [
      "Deeply cleans out clogged pores",
      "Removes dirt & oil without over-drying",
  ...
  },
  {
    ...
    num: "02",
    tag: "Step Two",
    title: "ilika's Hydrating Toner",
    subtitle: "Balance, Brighten & Prep",
    body: "Restore your skin's pH and lock in your freshly cleansed pores with this antioxidant-rich toner infused with natural extracts. It seals in the cleanse and bridges the gap between cleansing and moisturizing.",
    benefits: [
      "Closes & locks pores after cleansing",
  ...
  },
  {
    ...
    num: "03",
    tag: "Step Three",
    title: "ilika's Face Moisturizer",
    subtitle: "Lock In Hydration All Day",
    body: "A lightweight, fast-absorbing moisturizer that locks in moisture and seals it within the skin. The final seal on your CTM routine — protecting, plumping and perfecting your complexion.",
    benefits: [
