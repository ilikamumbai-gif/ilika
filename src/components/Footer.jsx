...
const Footer = () => {
  return (
    <footer className="w-full primary-bg-color pt-8 overflow-hidden">
      ...
      {/* MAIN FOOTER */}
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-10 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        {/* RIGHT (SOCIAL ICONS) */}
        <div className="flex md:flex-col gap-6 items-center md:items-end justify-center">
