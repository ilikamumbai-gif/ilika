...
const Footer = () => {
  return (
    <footer className="w-full primary-bg-color pt-8 overflow-hidden mt-auto flex-shrink-0">

      {/* PUSH FOOTER TO SCREEN BOTTOM */}
      <div className="min-h-[calc(100vh-1px)] flex flex-col justify-end">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 py-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div className="space-y-6 text-center md:text-left">
            <Link to="/about" className="hover:text-black flex justify-center md:justify-start items-center gap-3">
              <Info />
              <span className="heading-color font-semibold">About Us</span>
            </Link>

            <Link to="/contact" className="hover:text-black flex justify-center md:justify-start items-center gap-3">
              <Phone />
          ...
          <div className="flex flex-wrap md:flex-col gap-6 items-center md:items-end justify-center">
            ...
            <a href="https://youtubee.com" target="_blank" rel="noopener noreferrer">
        ...
        <div className="MiniDivider-bg-color content-text text-xs sm:text-sm py-4">
          <div className="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row justify-between items-center gap-4 text-center lg:text-left">
            ...
            <p>© 2025 Ilika | Design with Love in India</p>

            <div className="flex gap-4 flex-wrap justify-center">
              <Link to="/termsandcondition"><span className="hover:underline">Terms & Conditions</span></Link>
              <Link to="/privacy"><span className="hover:underline">Privacy</span></Link>
              <Link to="/return"><span className="hover:underline">Returns</span></Link>
              <Link to="/shippingpolicy"><span className="hover:underline">Shipping</span></Link>
              <Link to="/faq"><span className="hover:underline">FAQ</span></Link>
            </div>
