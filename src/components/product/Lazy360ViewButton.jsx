  ...
  return (
    <>
      <button
        ...
        className={`relative z-10 inline-flex items-center justify-center rounded-full border border-[#e8d6cf] bg-white px-4 py-2.5 text-sm font-semibold text-[#3e2a24] shadow-[0_12px_32px_rgba(69,39,34,0.08)] transition hover:-translate-y-0.5 hover:border-[#d9b5aa] hover:bg-[#fff8f6] hover:shadow-[0_18px_36px_rgba(69,39,34,0.12)] ${className}`}
      >
        View 360°
      </button>
