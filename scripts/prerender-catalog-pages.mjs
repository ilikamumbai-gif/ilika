...
async function main() {
  ...
  await writeRoute(template, distDir, "/articles", `<main id="prerendered-content" data-prerendered="article-index"><a href="/blog">Back to Ilika Journal</a><h1>Ilika Articles</h1><p>Explore our complete collection of beauty, skincare and haircare articles.</p><h2>All articles</h2><ul>${blogLinks}</ul></main>`, { title: "Ilika Articles | Beauty, Skincare and Haircare Guides", description: "Browse all Ilika articles, including skincare advice, haircare guides and beauty device tips.", canonical: `${SITE_URL}/articles` });
  await writeRoute(template, distDir, "/blog", `<main id="prerendered-content" data-prerendered="blog-index"><h1>Ilika Journal</h1><p>Explore Ilika beauty, skincare and haircare guides.</p><h2>Ilika Articles</h2><p><a href="/articles">Browse all articles</a></p><h2>Featured guides</h2><ul><li><a href="/blog/hair-dryer-pricing-delivery-india">Ilika Hair Dryer: Pricing and Delivery in India</a></li><li><a href="/blog/face-mask-maker-pricing-delivery-india">Ilika Face Mask Makers: Pricing and Delivery in India</a></li></ul><p><a href="/hair-dryer-guides">Hair dryer guides</a></p></main>`,  { title: "Ilika Blog | Skincare and Beauty Guides", description: "Browse Ilika skincare, beauty, haircare, and device guides.", canonical: `${SITE_URL}/blog` });
